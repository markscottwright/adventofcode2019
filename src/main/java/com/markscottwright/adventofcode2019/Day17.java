...
public class Day17 {
    ...
    static class ScaffoldingMapBuilder implements IntcodeOutput {
        ...
        public Set<Point> getIntersections() {
            return scaffoldingPoints.stream()
                    .filter(p -> scaffoldingPoints.contains(p.moveUp(1))
                            && scaffoldingPoints.contains(p.moveDown(1))
                            && scaffoldingPoints.contains(p.moveLeft(1))
                            && scaffoldingPoints.contains(p.moveRight(1)))
    ...
    public static void main(String[] args) {
        try {
            ...
            var intcodeComputer = new IntcodeComputer(IntcodeComputer.parse(INPUT),
                    new EmptyIntcodeComputerInput(), scaffoldingMap);
            intcodeComputer.run();
