...
public class IntcodeComputer {
	...
	public IntcodeComputer(List<Long> list, Iterator<Long> input, IntcodeOutput output) {
		for (int i = 0; i < list.size(); ++i)
			this.instructions.put(i, list.get(i));
		this.instructionPointer = 0;
		this.input = input;
	...
	public boolean runOneInstruction() throws IntcodeException {
		...
		// adjust relative base
			...
			throw new IntcodeException(
					"unknown instruction " + instructions.get(instructionPointer) + " at " + instructionPointer);
	...
	public String toString() {
		return "IntcodeComputer [state=" + state + ", pauseWhenInputEmpty=" + pauseWhenInputEmpty
				+ ", instructionPointer=" + instructionPointer + ", relativeBase=" + relativeBase + "]";
	}
}
