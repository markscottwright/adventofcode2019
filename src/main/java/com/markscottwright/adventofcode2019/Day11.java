...
public class Day11 {
    ...
    public static void main(String[] args) throws IntcodeException {
        ...
        EmergencyHullPaintingRobot robotStartingOnWhitePanel = new EmergencyHullPaintingRobot();
        robotStartingOnWhitePanel.paintedWhite
                .add(robotStartingOnWhitePanel.position);
        new IntcodeComputer(instructions, robot, robot).run();
        robot.printPaintingOn(System.out);
    }
}
